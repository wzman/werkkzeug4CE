...
COPY /Y wz4\werkkzeug4\release_dx9_Win32\werkkzeug4.exe data\bin\werkkzeug4_dx9_x32.exe
...
COPY /Y wz4\wz4player\release_dx9_Win32\wz4player.exe data\bin\wz4player_dx9_x32.exe
